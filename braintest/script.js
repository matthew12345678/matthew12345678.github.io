...
function startPlayback() {
    ...
    dataInterval = setInterval(() => {
        ...
        // Update test2 slider with the current value
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function modulationLoop() {
        ...
        const testSliderValue = parseFloat(document.getElementById('test2Slider').value);
        ...
        const testSliderMinFixed = -7; // Fixed range of the global Test2 slider
        const testSliderMaxFixed = 1;  // Fixed range of the global Test2 slider
