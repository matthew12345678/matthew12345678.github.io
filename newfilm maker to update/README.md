...
```bash
cd "/Users/puta/Desktop/opto films apps/newfilm maker to update"
...
## Upload to GitHub (without node_modules)

Only upload source files and lockfiles. Do **not** upload `node_modules/` (it is auto-generated and already ignored by `.gitignore`).
